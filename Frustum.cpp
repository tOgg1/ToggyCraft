...
void Frustum::setFrustum(glm::mat4 &mat)
{
	...
	planes[0].b = mat[4][3] + mat[1][3];
	planes[0].b = mat[4][4] + mat[1][4];

	//right
	planes[1].a = mat[4][1] - mat[1][1];
	planes[1].b = mat[4][2] - mat[1][2];
	planes[1].b = mat[4][3] - mat[1][3];
	planes[1].b = mat[4][4] - mat[1][4];

	//bottom
	planes[2].a = mat[4][1] + mat[2][1];
	planes[2].b = mat[4][2] + mat[2][2];
	planes[2].b = mat[4][3] + mat[2][3];
	planes[2].b = mat[4][4] + mat[2][4];

	//top
	planes[3].a = mat[4][1] - mat[2][1];
	planes[3].b = mat[4][2] - mat[2][2];
	planes[3].b = mat[4][3] - mat[2][3];
	planes[3].b = mat[4][4] - mat[2][4];
	
	//near
	planes[4].a = mat[4][1] + mat[3][1];
	planes[4].b = mat[4][2] + mat[3][2];
	planes[4].b = mat[4][3] + mat[3][3];
	planes[4].b = mat[4][4] + mat[3][4];

	//far
	planes[5].a = mat[4][1] - mat[1][1];
	planes[5].b = mat[4][2] - mat[1][2];
	planes[5].b = mat[4][3] - mat[1][3];
	planes[5].b = mat[4][4] - mat[1][4];
}
